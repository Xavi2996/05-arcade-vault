# SPEC 10 — Juego real de ASFALTO integrado a la plataforma

> **Estado:** Aprobado
> **Depende de:** SPEC 05, SPEC 06
> **Fecha:** 2026-09-21
> **Jam:** Cruza la carretera y el río sin convertirte en papilla · concepto 1 de 3 · diseño de juego en [`design.md`](./game-jam/cruza-la-carretera-y-el-rio/GJ-01-asfalto/design.md)
...
- Migración `supabase/migrations/0006_add_asfalto.sql` con un `insert into public.games (...)` de **fila nueva** (no reemplaza ningún placeholder), con `playable = true`.
...
```sql
-- supabase/migrations/0006_add_asfalto.sql
...
1. Crear y aplicar `supabase/migrations/0006_add_asfalto.sql`; confirmar con `execute_sql` que la fila existe con `playable = true`.
